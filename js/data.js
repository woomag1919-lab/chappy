...
const RELATION_Q={
 romantic:[
  {q:'相手からの言葉や態度に、好意や大切にされている感覚があると安心しやすい',axis:'distance',dir:-1},
  ...
  {q:'二人で決めた予定やルールは、できるだけ変えずに続けたい',axis:'change',dir:-1},
  ...
  {q:'相手とやり方が違っても、試しながら二人に合う形を見つければいいと思う',axis:'change',dir:1},
  {q:'大事な話では、結論だけでなく『なぜそう思ったか』も共有したい',axis:'thinking',dir:-1},
  {q:'二人の将来について話すとき、一つの答えよりいくつかの選択肢を考えたい',axis:'thinking',dir:1}
 ],
 friend:[
  ...
  {q:'友人から意見を求められたら、遠回しより自分の考えをはっきり伝えたい',axis:'communication',dir:1},
  {q:'相手の考えを聞く前に、自分の中でいくつかの可能性を考えることがある',axis:'thinking',dir:1},
  {q:'友人に嫌なことをされたときは、何が嫌だったかを具体的に伝えたい',axis:'language',dir:-1},
  {q:'友人との間でモヤモヤしたとき、気持ちを言葉にしてから動きたい',axis:'emotion',dir:-1},
 ...
 work:[
  ...
  {q:'ミスを指摘されたときは、感情より先に事実や原因を整理すると対応しやすい',axis:'thinking',dir:-1},
  ...
  {q:'仕事で強く落ち込んだとき、その場で話さず一度落ち着いてから向き合うことがある',axis:'emotion',dir:1},
