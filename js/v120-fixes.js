...
(function(){
  ...
  function install(){
    ...
    const toConversation=document.getElementById('v72ToConversation');
    ...
    /* Page 1: self only. Keep the original partner picker in the DOM because its existing app.js handler opens the profile editor. */
    ...
    /* Replace the four-dot pager with a five-step pager. */
    ...
    /* Keep the pager state in sync with the actual five visible steps. */
